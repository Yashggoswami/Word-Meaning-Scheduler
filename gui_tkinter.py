...
root.title('Word Meaning Scheduler')

#this creates 'Label' widget for Registration Form and uses place() method.
label_0 =Label(root,text="Word Meaning Scheduler", width=30,font=("bold",20))
...
label_1 =Label(root,text="choose Number of words you like to learn", width=40,font=("bold",15))
label_1.place(x=68,y=200)

#this will accept the input string text from the user.
entry_1=Entry(root)
entry_1.place(x=240,y=400)
